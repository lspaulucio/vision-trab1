...
class Object:
    ...
    def __init__(self):
        ...
        self.vectors = None
        self.stl = False
        self.rotationMatrix = Transforms.getRotationMatrix('z', 0)
        self.translationMatrix = Transforms.getTranslationMatrix(0, 0, 0)

    def loadFile(self, filename):
        self.stl = False
        self.points = np.loadtxt(filename).T
        self.points = np.vstack((self.points, np.ones(self.points.shape[1])))
